export const reportsData = {
  ...
  categories: [
    ...
    { icon: 'ti-leaf', label: 'Báo cáo môi trường tuần', suffix: '<i class="ti ti-download" style="color:var(--color-text-info)"></i>' },
  ...
  rows: [
    ...
    { domain: 'Môi trường', kpi: 'AQI trung bình', actual: '68', target: '≤ 75', trend: '▲ Đạt', trendColor: '#1D9E75' },
    { domain: 'Tiện ích', kpi: 'Đèn LED hoạt động', actual: '99,3%', target: '≥ 99,5%', trend: '▼ Chưa đạt', trendColor: '#A32D2D' },
