...
const extraBuildings = [
  ...
  { id: 'F1', label: 'T11', name: 'Tháp mở rộng Tây Bắc', pos: [-45, 0, -18], size: [4.4, 12, 4.2], color: '#eef1f5', accent: '#185FA5', roof: true },
  { id: 'F2', label: 'T12', name: 'Tháp mở rộng Đông Bắc', pos: [45, 0, -18], size: [4.8, 15, 4.2], color: '#eef1f5', accent: '#1D9E75', roof: true },
  { id: 'F3', label: 'T13', name: 'Khối mở rộng Tây Nam', pos: [-45, 0, 18], size: [5.2, 9, 4.5], color: '#f0f2f5', accent: '#EF9F27', roof: true },
  { id: 'F4', label: 'T14', name: 'Khối mở rộng Đông Nam', pos: [45, 0, 18], size: [5.2, 11, 4.5], color: '#f0f2f5', accent: '#85B7EB', roof: true },
  { id: 'F5', label: 'T15', name: 'Tháp phía Bắc 1', pos: [-28, 0, -43], size: [4.8, 15, 4.2], color: '#eef1f5', accent: '#1D9E75', roof: true },
  { id: 'F6', label: 'T16', name: 'Tháp phía Bắc 2', pos: [28, 0, -43], size: [4.4, 12, 4.2], color: '#eef1f5', accent: '#185FA5', roof: true },
  { id: 'F7', label: 'T17', name: 'Khối phía Nam 1', pos: [-28, 0, 43], size: [5.2, 11, 4.5], color: '#f0f2f5', accent: '#85B7EB', roof: true },
  { id: 'F8', label: 'T18', name: 'Tháp phía Nam 2', pos: [28, 0, 43], size: [4.8, 15, 4.2], color: '#eef1f5', accent: '#1D9E75', roof: true },
];
...
export const smartcitySceneData = {
  ...
  cameraPresets: {
    overview: { pos: [0, 80, 30], target: [0, 1.2, 0], fov: 50, hint: 'Tổng quan thành phố' },
    traffic: { pos: [0, 66, 24], target: [0, 0.8, 0], fov: 44, hint: 'Theo dõi giao thông tại vòng xuyến' },
    security: { pos: [0, 52, 0.01], target: [0, 0, 0], fov: 55, hint: 'Camera an ninh và đội xử lý' },
    environment: { pos: [0, 32, 62], target: [0, 2.2, 0], fov: 44, hint: 'Toàn cảnh hạ tầng và công viên' },
    utilities: { pos: [1, 44, 56], target: [0, 1.4, 0], fov: 46, hint: 'Dịch vụ cư dân Vin' },
    reports: { pos: [0, 34, 38], target: [0, 2, 0], fov: 48, hint: 'Báo cáo tổng hợp' },
  },
  roads: [
    { id: 'road-main-ew', pos: [0, 0, 0], size: [120, 14], rotation: 0, type: 'primary' },
    { id: 'road-main-ns', pos: [0, 0, 0], size: [14, 120], rotation: 0, type: 'primary' },
  ],
  intersections: [
