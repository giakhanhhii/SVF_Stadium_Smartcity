...
export const servicesData = {
  ...
  kpis: [
    { icon: 'ti-parking', label: 'Bãi đỗ xe', value: `${parkingVehicleSummary.usagePct}%`, sub: `${parkingVehicleSummary.cars} ô tô · ${parkingVehicleSummary.motorbikes} xe máy`, accent: '#534AB7' },
  ...
  alerts: [
    { accent: '#BA7517', tag: 'CẢNH BÁO', tagBg: '#FAEEDA', tagColor: '#854F0B', time: '5 phút trước', title: `Bãi ${busiestParkingLot.id} đông — ${busiestParkingLot.usagePct}% sử dụng`, desc: 'Đề xuất chuyển hướng sang P3 • Cập nhật biển LED' },
