// Cấu hình nguồn dữ liệu IOC Stadium. Đổi provider ở ĐÂY là đủ —
...
export const dataConfig = {
  provider: 'mock',
  restBaseUrl: '/api/stadium',
  streamUrl: `ws://${typeof location !== 'undefined' ? location.host : 'localhost:3457'}/stadium-stream`,
};
